...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-12 15:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/7a43f975-3ccb-4a0c-972a-ced2901b888a.git
$ cd 7a43f975-3ccb-4a0c-972a-ced2901b888a
```
